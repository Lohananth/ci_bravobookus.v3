<?php
  if ('POST' === $_SERVER['REQUEST_METHOD']) { 
		$to        = "info@i1booking.com, i1bookingservices@gmail.com";
		$owner	   = "i1Booking";
		$title     = $_POST['title'];  
		...
		$mail_header = " 
			<div>
				<div style='padding:10px; background: #0072C6;'>
					<a href='http://www.i1booking.com/' target='_blank'><img src='https://i1booking.com/images/asset/logo2.png' alt='I 1 booking'/></a>
