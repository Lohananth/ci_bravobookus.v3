				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Schedule <?php echo $form_title; ?></h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Schedules <?php echo $form_title; ?></span></li>
							</ol>
											...
											<div class="widget-summary widget-summary-sm">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">Blocked </strong><span class="text-primary">(23)</span>
														</div>
													</div>
											...
											<div class="widget-summary widget-summary-sm">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Schedules</h4>
														<div class="info">
															<strong class="amount">Report </strong><span class="text-primary">(Find)</span>
														</div>
													</div>
