<section role="main" class="content-body" style="margin-top: -30px;">
					<header class="page-header">
						<h2><i class="fa fa-home"></i> Manage <?php echo $form_title;  ?></h2>

					<div class="right-wrapper pull-left">
							<ol class="breadcrumbs">
								<li>
									<a href="<?php echo site_url(); ?><?php echo $this->uri->segment(1); ?>">								
									</a>
								</li>								
								<div class="btn btn-default" style="margin-right:10px;">
									<a href="<?php echo site_url(); ?><?php echo $this->uri->segment(1); ?>/add"> 
										<i class="fa fa-plus"></i>
										Add
									</a>
								</div>
								<div class="btn btn-danger" style="margin-right:10px;">
									<a href="<?php echo site_url(); ?><?php echo $this->uri->segment(1); ?>/removed"> 
										<i class="fa fa-trash-o" aria-hidden="true"></i>
										Removed
									</a>
								</div>
								<div class="btn btn-success"> <a href="<?php echo site_url(); ?><?php echo $this->uri->segment(1); ?>/blocked"> 
										<i class="fa fa-ban"></i>
										Blocked
									</a>
								</div>
