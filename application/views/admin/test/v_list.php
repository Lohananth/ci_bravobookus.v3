...
<!-- 					<a href="<?php  $this->uri->segment(1); ?><?php echo site_url(); ?>add-schedules.html"> 
		  		...
		  		<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#myModalAdd"><i class="fa fa-plus" data-toggle="tooltip" title="Add category">Add</i></button>					
				</div>
				...
				<tbody id="list-vehicle-row">									
					...
					?>
						...
						<td class="center hidden-phone">
							<a data-toggle="tooltip" dataid="<?php echo $vch['id']; ?>" title="Edit <?php echo $vch['vehicle_name']; ?>" href="<?php echo site_url(); ?>edit-schedules.html/<?php echo $vch['id']; ?>" class="btn btn-primary btn-sm edit" role="button"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
							</a>
						...
						<?php 
							if($vch['status']==1){ ?>
							<a data-toggle="tooltip" data-toggle="modal" data-target="#myModalBlock" dataid="<?php echo $vch['id']; ?>" data_controller_link="Select2_Controller/get_block_Schedule" title="Block <?php echo $vch['vehicle_name']; ?>" href="#<?php echo $vch['id']; ?>" class="btn btn-danger btn-sm btn_getBlocked" role="button"><i class="fa fa-ban"></i>
							</a>
						<?php
							} else {?>								
							<a data-toggle="tooltip" data-toggle="modal" data-target="#myModalActive" dataid="<?php echo $vch['id']; ?>" data_controller_link="Select2_Controller/get_active_Schedule"title="Active <?php echo $vch['vehicle_name']; ?>" href="<?php echo site_url(); ?>#<?php echo $vch['id']; ?>" class="btn btn-success btn-sm btn_getActive" role="button"><i class="fa fa-check"></i>
							</a>
						<?php
							}
						?>
