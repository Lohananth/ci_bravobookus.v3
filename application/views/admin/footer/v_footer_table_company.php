...
<script type="text/javaScript">
	$(document).ready(function(){
		...
		$('#btn-blocked').on('click',function(e){
	    	...
	    	$.ajax({
	    		url : "<?php echo base_url() ?>admin/users/companies/update_block_Company",
	    		type: "POST",
	    		data: $('#frmBlock').serialize(),
	    		dataType: 'json',
	    		success:function(data){
	    			// alert('Company was Blocked successfully...');
	    			location.reload();
	    			//Hide myModalDelete
...
//======================== Active ============================//
		...
		$('#list-row').on('click','.btn_getActive',function(e){
    		...
    		$.ajax({    		
	    		...
	    		url : "<?php echo base_url() ?>admin/users/companies/get_active_Company",
	    		type: "POST",
	    		data: {id:id},
	    		dataType: 'json',
	    		success:function(data){
		...
		$('#btn-Active').on('click',function(e){
	    	...
	    	$.ajax({
	    		url : "<?php echo base_url() ?>admin/users/companies/update_active_Company",
	    		type: "POST",
		...
		// View Data
		//get block Schedule for Active
		$('#list-row').on('click','.btn_getView',function(e){
		 	e.preventDefault();
		 	var id = $(this).attr('dataid');
		 	var control_link=$(this).attr('data_controller_link');
    		$.ajax({    		
	    		
	    		url : "<?php echo base_url() ?>admin/users/companies/viewForm",
	    		type: "POST",
	    		data: {id:id},
	    		dataType: 'json',
	    		success:function(data){
