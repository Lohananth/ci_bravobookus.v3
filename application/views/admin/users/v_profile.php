									...
									<div id="overview" class="tab-pane active">
										...
										<section class="simple-compose-box mb-xlg">
											<form method="get" action="/">
												<textarea name="message-text" data-plugin-textarea-autosize="" placeholder="What's on your mind?" rows="1" style="overflow: hidden; overflow-wrap: break-word; resize: none; height: 54px;"></textarea>
											</form>
										...
										<form class="form-horizontal" method="get">
											...
											<fieldset>
												<div class="form-group">
													...
													<div class="col-md-8">
														<input class="form-control" id="profileFirstName" type="text">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileLastName">Last Name</label>
													<div class="col-md-8">
														<input class="form-control" id="profileLastName" type="text">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileAddress">Address</label>
													<div class="col-md-8">
														<input class="form-control" id="profileAddress" type="text">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileCompany">Company</label>
													<div class="col-md-8">
														<input class="form-control" id="profileCompany" type="text">
													</div>
												</div>
											</fieldset>
												...
												<div class="form-group">
													...
													<div class="col-md-8">
														<div class="checkbox-custom checkbox-default checkbox-inline mt-xs">
															<input checked="" id="profilePublic" type="checkbox">
											...
											<fieldset class="mb-xl">
												<div class="form-group">
													...
													<div class="col-md-8">
														<input class="form-control" id="profileNewPassword" type="text">
													</div>
												</div>
												<div class="form-group">
													<label class="col-md-3 control-label" for="profileNewPasswordRepeat">Repeat New Password</label>
													<div class="col-md-8">
														<input class="form-control" id="profileNewPasswordRepeat" type="text">
													</div>
												</div>
											</fieldset>
