		...
		<div data-collapsed="0" class="panel">
			...
			<div class="panel-heading">
				<div class="panel-title">
					...
					<h2 class="panel-title"><i class="fa fa-edit" aria-hidden="true"></i> <?php echo ucfirst ($this->uri->segment(3)." ".$this->uri->segment(2)); ?> <?php //echo $tbl_vehicle[0]['vehicle_name']; ?></h2>
				</div>
			</div>
