<section role="main" class="content-body">
	<header class="page-header">
		<h2>Advanced <?php echo ucfirst ($this->uri->segment(2));  ?></h2>					
		<div class="right-wrapper pull-right">
			<ol class="breadcrumbs">
				...
				<li><span><?php echo ucfirst ($this->uri->segment(2));  ?></span></li>
				<li><span><?php echo ucfirst ($this->uri->segment(3));  ?></span></li>
			</ol>					
	...
	<div class="col-md-12">
		...
		<div data-collapsed="0" class="panel">
			...
			<form  action="<?php echo site_url();?>admin/users/companies/save/create" method="post" accept-charset="utf-8" enctype='multipart/form-data'>
 ...
 -->
					...
					<div class="col-md-5 form-group">
						<select multiple data-plugin-selectTwo class="form-control populate" multiple="multiple" name="service_detail[]" placeholder="Click here to select" required="required">
					...
					<div class="col-md-12 form-group">
						...
						<a class="btn btn-danger pull-right" style="margin-right: 15px;" href="<?php echo site_url(); ?>admin/companies/list/active"><i class="fa fa-chevron-left" aria-hidden="true"></i> Back</a>
					</div>	
