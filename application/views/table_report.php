...
<body>
  ...
  <img id="logo" src="./images/image_with_alpha.png" width="50" alt="Logo">
  <!-- <img src="<?php echo $_SERVER['DOCUMENT_ROOT']."/ci_bravobookus.v3/images/image_with_alpha.png"; ?>" width="50"> -->
	<div id="outtable">
	  <table>
	  	<thead>
	  		<tr>
